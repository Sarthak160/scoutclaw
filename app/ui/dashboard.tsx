...
interface DashboardData {
  ...
  run: RunView;
  resumeInsights: ResumeInsightsView;
}
...
export default function Dashboard() {
  const [dashboard, setDashboard] = useState<DashboardData>(EMPTY_STATE);
...
function getInsightLabels(activeMode: string, jobOpeningUrl: string): InsightLabels {
